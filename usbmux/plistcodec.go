...
func NewPlistCodec(deviceConnection *DeviceConnection, responseChannel chan []byte) *PlistCodec {
...
func (plistCodec *PlistCodec) Encode(message interface{}) ([]byte, error) {
	...
	log.Debug("Lockdown send", reflect.TypeOf(message), " on ", &plistCodec.deviceConnection.c)
...
func (plistCodec *PlistCodec) Decode(r io.Reader) error {
	...
	log.Debug("Lockdown receive on ", &plistCodec.deviceConnection.c)
